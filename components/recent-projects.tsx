      ...
      <div className="mt-10 flex flex-wrap items-center justify-center gap-x-24 gap-y-8 p-4">
        {Project.map(
          ({ id, des, iconLists, img, link, sourceCode, title }) => (
            ...
            >
              <PinContainer title="Visit" href="https://kiran.netlify.app">
                <div className="relative mb-10 flex h-[30vh] w-[80vw] items-center justify-center overflow-hidden sm:h-[40vh] sm:w-[570px]">
                  <div className="relative h-full w-full overflow-hidden bg-[#13162d] lg:rounded-3xl transform transition-transform duration-300 hover:scale-105 shadow-[0_0_20px_5px_rgba(255,255,255,0.3)] filter brightness-110">
                    <Image
                      height={330}
                      width={552}
                      src="/bg.png"
